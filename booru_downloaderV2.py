...
banned_tag = "parody,comic,chibi,monochrome,lowres"
keep_tag = ""
conditional_tag = "1other:1girl:2girls:2boys:3girls:3boys"
from_date = ""
to_date = ""
save_tags = True
save_json = True
                    ...
                    if image_url:
                        ...
                        if download_image(image_url, download_path, file_prefix): 
                            ...
                            if download_count >= force_max_download:
                                print("Reached the maximum allowed downloads. Exiting...")
                                return
...
if __name__ == "__main__":
    ...
    zip_output_filename = "downloaded_images.zip"
